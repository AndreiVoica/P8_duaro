...
<img src = "../../images/TFModels.png" width="1000">
...
<img src = "../../images/ReadAngles.png" width="400">

2. In the `Inspector` make sure that `Record Model` script is selected.

<img src = "../../images/RecordModel.png" width="400">

3. After stopping the Unity, a recording will be saved as a <name>.csv file under the main Unity folder
...
<img src = "../../images/ManualControl.png" width="400">
...
<img src = "../../images/RemoveModel.png" width="700">

3. Go to `Scripts` folder and open the `DuaroAgentComplexWT.cs` script.

<img src = "../../images/Scripts.png" width="700">

4. Comment lines 199 through 207 

<img src = "../../images/HeuristicControl.png" width="700">
