...
namespace RosMessageTypes.DuaroMoveitConfig
{
    ...
    {
        public const string k_RosMessageName = "duaro_moveit_config/MoverService";
        public override string RosMessageName => k_RosMessageName;

        public DuaroMoveitJointsMsg joints_input;
        public Geometry.PoseMsg pick_pose;
        public Geometry.PoseMsg place_pose;

        public MoverServiceRequest()
        {
            this.joints_input = new DuaroMoveitJointsMsg();
            this.pick_pose = new Geometry.PoseMsg();
            this.place_pose = new Geometry.PoseMsg();
        }

        public MoverServiceRequest(DuaroMoveitJointsMsg joints_input, Geometry.PoseMsg pick_pose, Geometry.PoseMsg place_pose)
        {
        ...
        {
            this.joints_input = DuaroMoveitJointsMsg.Deserialize(deserializer);
